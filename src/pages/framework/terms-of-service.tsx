      ...
      {language === "zh" ? (
        <div className="bg-white rounded-lg shadow-md p-8 h-screen overflow-y-scroll">
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>
              以任何违法目的使用我们的服务，或者邀请他人进行或参与任何违法行为。
            </li>
            <li>
              违反任何国际、联邦、省级、或州级法规、规则、法律或地方法令。
            </li>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 h-screen overflow-y-scroll">
          ...
          <p className="mb-4">
            Welcome to FGA Tech Team (&quot;we,&quot; &quot;our,&quot; or
            &quot;us&quot;). These Terms of Service (&quot;Terms&quot;) govern
            your use of our technology products and services
          ...
          <p className="mb-4">
            ...
            accordance with these Terms. You are responsible for your use of our
            Services and for any content you provide, including compliance with
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>
              Use our Services for any unlawful purpose or to solicit others to
          ...
          <p className="mb-4">
            The content, features, and functionality of our Services are and
            will remain the exclusive property of FGA Tech Team and its
          ...
          <p className="mb-4">
            In no event shall FGA Tech Team, nor its directors, employees,
