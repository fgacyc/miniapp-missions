    ...
    <div>
      ...
      {language === "zh" ? (
        <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll h-screen">
          ...
          <p className="mb-4">
            根据您的所在地，您可能具有以下关于您的个人信息的权利：
          </p>
          <ul className="list-disc pl-8 mb-4">
            <li>访问权 – 您有权要求获取您的个人信息的副本。</li>
            <li>
              更正权 –
              您有权要求我们更正您认为不准确的信息或补充您认为不完整的信息。
            </li>
            <li>删除权 – 在一定条件下，您有权要求我们删除您的个人信息。</li>
            <li>
              限制处理权 –
              在一定条件下，您有权要求我们限制对您的个人信息的处理。
            </li>
            <li>
              反对处理权 – 在一定条件下，您有权反对我们对您的个人信息的处理。
            </li>
            <li>
              数据可移植性权 –
        ...
        <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll h-screen">
          ...
          <p className="mb-4">
            FGA Tech Team ("we," "our," or "us") is committed to protecting your
            privacy. This Privacy Policy explains how we collect, use, disclose,
            and safeguard your information when you use our technology products
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>
              ...
              us when you register with the Services or when you choose to
          ...
          <ul className="list-disc pl-8 mb-4">
            ...
            <li>
              To communicate with you, including for customer service, to
          ...
          <p className="mb-4">
            We do not share your information with third parties for hosting
            services, customer service, or marketing efforts. We may share your
            information in the following situations:
          </p>
          <ul className="list-disc pl-8 mb-4">
            <li>
              To comply with legal obligations, including responding to
